...
if (!(isNull _shell)) then {[[[netid _shell,_shell],format["bon_Shell_In_v0%1",[1,2,3,4,5,6,7] select round random 6]], "MCC_fnc_globalSay3D", true, false] remoteExec ["MCC_fnc_globalSay3D", 0, false];};
		sleep _delay;
	};
