...
class MCC_leftButtonsControls: MCC_RscControlsGroup
{
	...
	class Controls
	{
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_SPAWN_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_SPAWN_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_CAS_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_CAS_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_AIRDROP_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_AIRDROP_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_ARTILLERY_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_ARTILLERY_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_EVAC_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_EVAC_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_IED_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_IED_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_CONVOY_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_CONVOY_TOOLTIP";
		...
		class MCC_AC130Button: MCC_RscButton
		{
			...
			text = "$STR_MCC_GROUPGEN_AC130_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_AC130_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_BRUSH_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_BRUSH_TOOLTIP";
		...
		{
			idc = 520;
			text = "$STR_MCC_GROUPGEN_ROLE_SELECTION_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_ROLE_SELECTION_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_ZEUS_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_ZEUS_TOOLTIP";
		...
		{
			idc = -1;
			text = "$STR_MCC_GROUPGEN_ARSENAL_BUTTON";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			tooltip = "$STR_MCC_GROUPGEN_ARSENAL_TOOLTIP";
