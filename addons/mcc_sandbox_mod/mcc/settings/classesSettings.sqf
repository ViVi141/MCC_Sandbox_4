...
//-======================= Squad Leader Deployable ==========================
//Bunker
[
    "MCC_initConstract_bunker",
    "EDITBOX",
    ["Bunker","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["Land_BagBunker_Small_F","Land_BagBunker_Small_F","Land_BagBunker_Small_F","Land_BagBunker_Small_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_bunker = call compile _value;
    }
] call CBA_Settings_fnc_init;

//wall
[
    "MCC_initConstract_wall",
    "EDITBOX",
    ["Wall","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["Land_BagFence_Long_F","Land_HBarrier_3_F","Land_BagFence_Long_F","Land_BagFence_Long_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_wall = call compile _value;
    }
] call CBA_Settings_fnc_init;

//hmg
[
    "MCC_initConstract_hmg",
    "EDITBOX",
    ["Heavy Machine Gun","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["O_HMG_01_F","B_HMG_01_F","O_HMG_01_F","O_HMG_01_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_hmg = call compile _value;
    }
] call CBA_Settings_fnc_init;

//hmgh
[
    "MCC_initConstract_hmgh",
    "EDITBOX",
    ["Heavy Machine Gun(high)","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["O_HMG_01_F","B_HMG_01_high_F","O_HMG_01_F","O_HMG_01_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_hmgh = call compile _value;
    }
] call CBA_Settings_fnc_init;

//gmg
[
    "MCC_initConstract_gmg",
    "EDITBOX",
    ["Grenade Machine Gun","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["O_GMG_01_F","B_GMG_01_F","O_GMG_01_F","O_GMG_01_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_gmg = call compile _value;
    }
] call CBA_Settings_fnc_init;

//gmgh
[
    "MCC_initConstract_gmgh",
    "EDITBOX",
    ["Grenade Machine Gun(high)","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["O_GMG_01_high_F","B_GMG_01_high_F","O_GMG_01_high_F","O_GMG_01_high_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_gmgh = call compile _value;
    }
] call CBA_Settings_fnc_init;

//at
[
    "MCC_initConstract_at",
    "EDITBOX",
    ["Anti-tank","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["O_static_AT_F","B_static_AT_F","O_static_AT_F","O_static_AT_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_at = call compile _value;
    }
] call CBA_Settings_fnc_init;

//aa
[
    "MCC_initConstract_aa",
    "EDITBOX",
    ["Anti-air","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["O_static_AA_F","B_static_AA_F","O_static_AA_F","O_static_AA_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_aa = call compile _value;
    }
] call CBA_Settings_fnc_init;

//mortar
[
    "MCC_initConstract_mortar",
    "EDITBOX",
    ["Bunker","Vechile class array where elements: 0- Opfor 1-Bluefor 2-Independent 3-Civilians"],
    ["MCC Classes", "SQL Deployable"],
    '["O_Mortar_01_F","B_Mortar_01_F","O_Mortar_01_F","O_Mortar_01_F"]',
    true,
    {
        params ["_value"];
        MCC_initConstract_mortar = call compile _value;
    }
] call CBA_Settings_fnc_init;
